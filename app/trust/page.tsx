...
export const metadata = {
  title: "Trust Center",
  description:
    "Trust, transparency, policy, contact, and verification information for GEM Cybersecurity Assist.",
};
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-5 max-w-4xl text-5xl font-black tracking-[-0.06em] text-white">
        Clarity, policy visibility, and operational transparency.
      </h1>
      <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">
        GEM is structured to give customers clear product pages, public contact
        information, transparent pricing, visible policies, and consistent
      ...
      <div className="mt-12 gem-panel rounded-[2rem] p-8">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {trustSignals.map((signal) => (
            <div
              key={signal}
              className="rounded-2xl border border-white/10 bg-slate-950/60 p-5 text-center text-sm font-bold text-slate-200"
            >
