      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-28">
        <div>
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
            Alliance Trust Market is now positioned as a cross-platform
            storefront hub: image-first, video-ready, product-description
            driven, and structured for TikTok Shop, Google Shopping, Shopify,
            Wish, Amazon, eBay, Meta, and future catalog feeds.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href="/" className="gem-btn-secondary">
              Existing GEM app
            </Link>
          </div>
          <div className="mt-10 grid gap-4 sm:grid-cols-4">
            <div className="gem-panel rounded-3xl p-5">
              <strong className="block text-3xl">100</strong>
              <span className="text-sm text-slate-400">Product records</span>
            </div>
            <div className="gem-panel rounded-3xl p-5">
            ...
            <div className="gem-panel rounded-3xl p-5">
              <strong className="block text-3xl">Media</strong>
              <span className="text-sm text-slate-400">
                Image and video slots
              </span>
            </div>
            <div className="gem-panel rounded-3xl p-5">
              <strong className="block text-3xl">Safe</strong>
              <span className="text-sm text-slate-400">
                Google app preserved
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="mt-6 grid gap-4">
            <div className="min-h-56 rounded-[2rem] border border-white/10 bg-gradient-to-br from-emerald-300/20 via-sky-300/10 to-slate-900 p-6">
              ...
              <h2 className="mt-16 text-3xl font-black tracking-tight">
                Visual first listing module
              </h2>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
                <div className="mb-4 grid h-16 w-16 place-items-center rounded-2xl bg-emerald-300/10 text-2xl">
                  ▶
                </div>
                <strong>Short video slot</strong>
                <p className="mt-2 text-sm text-slate-400">
                  Built for TikTok, Reels, Shorts, and product demos.
                </p>
              </div>
              <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
                <div className="mb-4 grid h-16 w-16 place-items-center rounded-2xl bg-sky-300/10 text-2xl">
                  ▧
                </div>
                <strong>Image gallery</strong>
                <p className="mt-2 text-sm text-slate-400">
                  Hero, lifestyle, detail, and package shots.
                </p>
              </div>
            </div>
          </div>
          ...
          {platforms.map((platform) => (
            <div key={platform} className="gem-panel rounded-3xl p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Product media, title, description, price, SKU, policy, and feed
                alignment.
              </p>
            </div>
          ))}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em]">
              Product image and video structure.
            </h2>
          </div>
        </div>
        <div className="grid gap-5 md:grid-cols-4">
          {mediaPlan.map(([title, body]) => (
            <article key={title} className="gem-panel rounded-3xl p-6">
              <div className="mb-5 grid h-14 w-14 place-items-center rounded-2xl border border-emerald-300/30 bg-emerald-300/10 text-emerald-100">
                ✓
              </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em]">
              Image and video-ready product grid.
            </h2>
          </div>
          <Link href="/alliance-market/products" className="gem-btn-secondary">
            View all products
          </Link>
        </div>
