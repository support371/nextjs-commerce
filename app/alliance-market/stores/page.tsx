...
const stores = [
  {
    ...
    focus:
      "Vertical videos, image posters, short captions, creator-style product storytelling.",
  ...
  },
  {
    ...
    href: "/store",
    focus:
      "Structured product data, merchant feed, policy coverage, SEO-safe product pages.",
  ...
  },
  {
    ...
    focus:
      "Product import workflow, SKUs, variants, images, inventory and checkout handoff.",
  ...
  },
  {
    ...
    href: "/alliance-market/products",
    focus:
      "Marketplace-ready listing cards, pricing, descriptions and lightweight product media.",
  ...
  },
  {
    ...
    href: "/alliance-market/products",
    focus:
      "Listing content, SKU mapping, policy checks, title and bullet formatting.",
    status: "Framework route active",
  },
  {
    name: "Meta / Pinterest",
    href: "/alliance-market/products",
    focus:
      "Visual shopping cards, catalog creatives, social discovery and product links.",
    status: "Framework route active",
  },
];
...
export const metadata = {
  ...
  description:
    "Separated store channels inside one Next.js Commerce framework.",
};
    ...
    <main className="bg-slate-950 text-white">
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          This is the reconstruction model: one Next.js Commerce codebase, but
          not one blended platform. TikTok, Google, Shopify, Wish, Amazon, eBay,
          Meta, and Pinterest are separated by route, content model, and
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {stores.map((store) => (
            <Link
              key={store.name}
              href={store.href}
              className="gem-panel rounded-[2rem] p-6 transition hover:bg-white/[0.09]"
            >
